...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img', models.ImageField(blank=True, upload_to='package/img/')),
                ('paket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='packages.Package')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maskapai', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='packages.PackageAirline')),
                ('paket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='packages.Package')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='package',
            name='akomodasi',
            field=models.ManyToManyField(blank=True, through='packages.PackageAccommodation', to='packages.PackageHotel'),
        ),
        migrations.AddField(
            model_name='package',
            name='author',
        ...
        migrations.AddField(
            model_name='package',
            name='fasilitas',
            field=models.ManyToManyField(blank=True, to='packages.PackageFacility'),
        ),
        migrations.AddField(
            model_name='package',
            name='kategori',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='packages.PackageCategory'),
        ),
        migrations.AddField(
            model_name='package',
            name='penerbangan',
            field=models.ManyToManyField(blank=True, through='packages.PackageFlight', to='packages.PackageAirline'),
        ),
        migrations.CreateModel(
            name='HotelImage',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dibuat_pada', models.DateTimeField(auto_now_add=True)),
                ('diperbarui_pada', models.DateTimeField(auto_now=True)),
                ('airline', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='packages.PackageAirline')),
            ],
            options={
                'ordering': ('id',),
            },
