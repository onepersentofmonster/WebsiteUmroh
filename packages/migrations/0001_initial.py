    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maskapai', models.CharField(max_length=225)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(blank=True, choices=[('populer', 'POPULER'), ('promo', 'PROMO'), (None, '--normal--')], help_text='Not required', max_length=7)),
                ('dibuat_pada', models.DateTimeField(auto_now_add=True)),
                ('diperbarui_pada', models.DateTimeField(auto_now=True)),
                ('slug', autoslug.fields.AutoSlugField(editable=False, populate_from='nama')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('fasilitas', models.ManyToManyField(blank=True, to='packages.Facility')),
                ('kategori', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='packages.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Image',
