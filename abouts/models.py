...
class About(models.Model):
    ...
    visi_misi = models.TextField(
        verbose_name='Visi & Misi', null=True, blank=True)
...
class Service(models.Model):
    ...
    nama = models.CharField(max_length=225, null=True, blank=True,
                            help_text='Biaya perjalanan termasuk/tidak-termasuk.')
...
class PhotosActivity(models.Model):
    about = models.ForeignKey(About, on_delete=models.CASCADE)
    img = models.ImageField(upload_to='about_us/photos_of_activities',
                            null=True, blank=True, help_text='Foto Kegiatan.')
    dibuat_pada = models.DateTimeField(auto_now_add=True)
    diperbarui_pada = models.DateTimeField(auto_now=True)
